...
Ближайшие улучшения после рабочего MVP: анализ устойчивости порогов/кластеров, временные повторяющиеся маршруты, проверяемые запросы на естественном языке. Сначала сохраняйте корректность контрактов и объяснений; новые метрики должны давать понятную пользу аналитику.
